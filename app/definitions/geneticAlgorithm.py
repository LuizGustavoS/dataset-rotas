...
class PopulationGenerator:
    ...
    def __init__(self, size, city_list):
        ...
        self.city_list.remove("Alto da Colina")
        self.size = size
    ...
    def __generateRoute(self):
        ...
        return ["Alto da Colina"] + mid_cities + ["Alto da Colina"]
...
class NaturalSelection:
    ...
    def __crossover(self, couple:tuple):
            ...
            return ["Alto da Colina"] + genes + ["Alto da Colina"]
    ...
    def __mutateWithChance(self, index:int, rate:float):
        ...
        # print(individual)
        individual = ["Alto da Colina"] + individual + ["Alto da Colina"]
